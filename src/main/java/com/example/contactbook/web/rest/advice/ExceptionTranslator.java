...
import com.example.contactbook.config.Constants;
import com.example.contactbook.web.rest.exception.*;
...
public class ExceptionTranslator implements ProblemHandling /*, SecurityAdviceTrait*/  {
    ...
    public ResponseEntity<Problem> handleEmailAlreadyUsedException(
            com.example.contactbook.service.exception.EmailAlreadyUsedException ex,
    ...
    public ResponseEntity<Problem> handleUsernameAlreadyUsedException(
            com.example.contactbook.service.exception.UsernameAlreadyUsedException ex,
        NativeWebRequest request
    ) {
    ...
    public ResponseEntity<Problem> handleInvalidPasswordException(
            com.example.contactbook.service.exception.InvalidPasswordException ex,
        NativeWebRequest request
    ) {
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "javax.", "com.", "io.", "de.", "com.example.contactbook");
    }
}
