...
/**
 * Integration tests {@link com.example.contactbook.web.rest.advice.ExceptionTranslator} controller advice.
 */
...
class ExceptionTranslatorIT {
    ...
    void testMethodArgumentNotValid() throws Exception {
        mockMvc
            .perform(post("/api/exception-translator-test/method-argument").content("{\"sdf\":\"\"}").contentType(MediaType.APPLICATION_JSON))
